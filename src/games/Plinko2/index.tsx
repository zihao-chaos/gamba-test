...
export default function Plinko2() {
              ...
              bodies.forEach(
                (body, i) => {
                  ...
                  if (label === 'Plinko') {
                    ...
                    baseImage.src = 'https://ca.slack-edge.com/T07CH2XFE-U58D384HW-750703e6fa94-192'
                    // ctx.drawImage(baseImage, 0,0 )
                    const imageSize = PLINKO_RAIUS * 4; // Adjust image size as needed
                    ...
                    ctx.fill()
                    ctx.drawImage(baseImage, -imageSize / 2, -imageSize / 2, imageSize, imageSize);
                    ctx.arc(0, 0, PLINKO_RAIUS * 3.5, 0, Math.PI * 2)
